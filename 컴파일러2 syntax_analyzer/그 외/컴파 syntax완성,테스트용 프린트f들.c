...
//char **tokenArray;
int size = 0; 
char tokenArray[MAX_ARRAY_SIZE][8];
...
void reduceAction(int n) {
    ...
    printf("n: %d delsize: %d X: %s %d\n",n, delSize, tokenArray[splitterIndex-1], reduceRS[n]);
}
